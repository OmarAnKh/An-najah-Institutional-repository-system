    ...
    return (
      <div className="mt-8 space-y-3">
        {[1, 2, 3].map((i) => (
          ...
          >
            <div className="h-4 bg-secondary rounded-lg w-3/4 mb-3" />
            <div className="h-3 bg-secondary rounded-lg w-full mb-2" />
        ...
        {results.map((result, index) => {
          ...
          return (
            <motion.a
              ...
              dir={direction}
              className="group block p-4 rounded-2xl bg-card hover:bg-secondary/50 transition-all duration-200"
